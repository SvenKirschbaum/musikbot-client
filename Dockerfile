#BUILD APP
FROM maven:3.9.9-amazoncorretto-21@sha256:3ce21bfedfac11986a38cfc02431912df2d7ad294e0bfefb4d98a24b4dfdeea1 AS build_app
WORKDIR /usr/src/app
COPY pom.xml .
COPY lib lib
...
#BUILD SPOTIFYD
FROM rust:1.86.0-bookworm@sha256:7b65306dd21304f48c22be08d6a3e41001eef738b3bd3a5da51119c802321883 AS build_spotifyd
