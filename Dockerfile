#BUILD APP
FROM maven:3.9.16-amazoncorretto-25@sha256:946aea92fe29dcced0fe022d7a70e6bb52f183e06677779db1b8d4cea6bc2f83 AS build_app
WORKDIR /usr/src/app
COPY pom.xml .
COPY lib lib
...
#BUILD SPOTIFYD
FROM rust:1.95.0-bookworm@sha256:6258907abe69656e41cd992e0b705cdcfabcbbe3db374f92ed2d47121282d4a1 AS build_spotifyd
