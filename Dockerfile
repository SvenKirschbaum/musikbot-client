#BUILD APP
FROM maven:3.9.9-amazoncorretto-21@sha256:d713be6874d7711b26384e169291bdf773cc2f1a6fbcb0ba0c603288d8a5fe45 AS build_app
WORKDIR /usr/src/app
COPY pom.xml .
COPY lib lib
...
#BUILD SPOTIFYD
FROM rust:1.81.0-bookworm@sha256:fcd390e0a3a6bfcf26969861efbe7b864df052aa71a361cf3cd7c5c585b1b413 AS build_spotifyd
