#BUILD APP
FROM maven:3.9.9-amazoncorretto-21@sha256:fbb6d3f2590f9769b802bb4cc2d08968240112ce0b28c97668bad8215bf296a9 AS build_app
WORKDIR /usr/src/app
COPY pom.xml .
COPY lib lib
...
#BUILD SPOTIFYD
FROM rust:1.85.1-bookworm@sha256:e51d0265072d2d9d5d320f6a44dde6b9ef13653b035098febd68cce8fa7c0bc4 AS build_spotifyd
